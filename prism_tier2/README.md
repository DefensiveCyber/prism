...
identifies their sourcetype using a 327-signature engine, cleans dirty content,
routes files into landing zones for Cribl pickup, and provides AI-powered
analysis via the Lens module.
